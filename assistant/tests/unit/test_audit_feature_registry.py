...
class TestFeatureEntry:
    def test_create_minimal(self):
        entry = FeatureEntry(
            id="test-feature", name="Test Feature", phase="fase-1", status="planned"
        )
...
class TestFeatureRegistry:
    ...
    def test_list(self):
        ...
        FeatureRegistry.register(
            FeatureEntry(id="b", name="B", phase="p1", status="done")
        )
    ...
    def test_search(self):
        FeatureRegistry.register(
            FeatureEntry(
                id="my-feature", name="My Feature", phase="p1", status="planned"
            )
        )
    ...
    def test_get_by_name(self):
        FeatureRegistry.register(
            FeatureEntry(id="test", name="Test Feature", phase="p1", status="planned")
        )

...
class SDDResolver:
    ...
    def _extract_linked_features(cls, content: str) -> list[str]:
        ...
        known_features = [
            "observability", "event-bus", "workflow-engine", "provider-adapters",
            "model-router", "circuit-breaker", "dead-letter-queue", "n8n-integration",
            "memory-system", "sse-layer", "tool-layer", "agent-runtime", "launcher",
            "auto-update", "database-schema", "service-registry", "core-contracts",
            "desktop-apis", "observability-production", "workflow-registry",
            "orchestrator", "plan-executor", "provider-selector", "health-cache",
            "base-workflow", "base-chat-provider", "base-embedding-provider",
        ]

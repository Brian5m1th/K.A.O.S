...
class AutomationWorkflow(Base):
    ...
    n8n_workflow_id: Mapped[str | None] = mapped_column(String(100), unique=True, nullable=True, index=True)
...
class AutomationExecution(Base):
    ...
    id: Mapped[UUID] = mapped_column(primary_key=True, default=uuid4)
    workflow_id: Mapped[UUID] = mapped_column(ForeignKey("automation_workflows.id", ondelete="CASCADE"), index=True)
    n8n_execution_id: Mapped[str | None] = mapped_column(String(100), nullable=True, index=True)

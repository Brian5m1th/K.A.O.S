...
def retrieve_context(state: AgentState) -> dict:
    ...
    if index_content:
        wiki_context.append(
            {"path": "wiki/index.md", "content": index_content, "score": 1.0}
        )
            ...
            for prefix in [
                ...
                if prefix in match:
                    ...
                    if content:
                        ...
                        logger.info(
                            f"[info] retrieve_context - wiki hit: {path_candidate}"
                        )
    ...
    qdrant_context = [
        {"path": r.path, "content": r.excerpt, "score": r.score} for r in results
    ]
